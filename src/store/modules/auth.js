...
export const mutationTypes = {
  ...
  updateCurrentUserWithGoogle: 'updateCurrentUserWithGoogle',
...
const mutations = {
  [mutationTypes.REGISTER_START](state) {
  ...
  [mutationTypes.updateCurrentUserWithGoogle](state, user) {
...
const actions = {
  [actionTypes.register](context, credentials) {
    return new Promise(resolve => {
      context.commit(mutationTypes.REGISTER_START)
      authApi
  ...
  [actionTypes.loginWithGoogle](context, user) {
    return new Promise(resolve => {
      //this.$store.commit('registerSuccess', user)
