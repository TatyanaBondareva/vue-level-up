<template>
    <div class="signup-buttons">
        <div id="fb-root"></div>
        <a href="#" class="google-signup" @click.prevent="loginWithGoogleAcc">
...
export default {
  ...
  methods: {
    ...mapActions('@/store/modules/auth', ['loginWithGoogle']),
    loginWithGoogleAcc () {
      this.$gAuth
        .signIn()
        .then(GoogleUser => {
          ...
          this.$store.commit('registerSuccess', userInfo.google.user)
          router.push('/home')
        })
        .catch(error => {
